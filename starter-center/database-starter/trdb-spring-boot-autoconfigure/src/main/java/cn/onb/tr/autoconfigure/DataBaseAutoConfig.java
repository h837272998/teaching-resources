...
@ConditionalOnProperty(name = {"tr.db.dynamic"}, matchIfMissing = false, havingValue = "true")
...
//	所有引入db-core的模块都需要一个核心库，可以是user-center，也可以是oauth-center,file-center ,sms-center
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource)
        ...
        sqlSessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:com/hjh/**/dao/*.xml"));
