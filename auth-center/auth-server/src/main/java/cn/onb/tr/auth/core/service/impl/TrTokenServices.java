...
/**
 * @Description: (onb)->AuthorizationServerTokenServices。
 * 实现登录返回新的token和新的refresh并删除旧的。
 * @Author: 、心
 * @Date: 19/12/22 15:32
 */
public class TrTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
